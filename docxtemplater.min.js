  ...
  return _createClass(Docxtemplater, [
    ...
    },
    {
      ...
      value: function setModules(obj) {
        for (
          var _i4 = 0, _this$modules2 = this.modules;
          _i4 < _this$modules2.length;
          _i4++
        ) {
    ...
    },
    {
      ...
      value: function sendEvent(eventName) {
        for (
          var _i6 = 0, _this$modules4 = this.modules;
          _i6 < _this$modules4.length;
          _i6++
        ) {
    ...
    },
    {
      ...
      value: function setOptions(options) {
        ...
        (_this$delimiters = this.delimiters).start &&
          (_this$delimiters.start = DocUtils.utf8ToWord(this.delimiters.start));
        (_this$delimiters2 = this.delimiters).end &&
          (_this$delimiters2.end = DocUtils.utf8ToWord(this.delimiters.end));
        return this;
      },
    },
    {
      ...
      value: function loadZip(zip) {
        ...
        for (
          var _i8 = 0, _this$modules6 = this.modules;
          _i8 < _this$modules6.length;
          _i8++
        ) {
    ...
    },
    {
      ...
      value: function getScopeManager(to, currentFile, tags) {
        ...
        (_this$scopeManagers = this.scopeManagers)[to] ||
          (_this$scopeManagers[to] = createScope({
            tags: tags,
            parser: this.parser,
    ...
    },
    {
      ...
      value: function resolveData(data) {
        ...
        return Promise.resolve(data).then(function (data) {
          ...
          return Promise.all(
            Object.keys(_this.mapper).map(function (to) {
              ...
              return Promise.resolve(data).then(function (data) {
                ...
                currentFile.scopeManager = _this.getScopeManager(
                  to,
                  currentFile,
                  data
                );
    ...
    },
    {
      ...
      value: function throwIfDuplicateModules() {
        var duplicates = getDuplicates(
          this.modules.map(function (_ref2) {
            var name = _ref2.name;
            return name;
          })
        );
        if (duplicates.length > 0) {
          throw new XTInternalError(
            'Detected duplicate module "'.concat(duplicates[0], '"')
          );
        }
      },
    },
    {
      ...
      value: function compile() {
        ...
        for (
          var _i10 = 0, _this$options$xmlFile2 = this.options.xmlFileNames;
          _i10 < _this$options$xmlFile2.length;
          _i10++
        ) {
         ...
         */
        for (
          var _i12 = 0, _this$templatedFiles2 = this.templatedFiles;
          _i12 < _this$templatedFiles2.length;
          _i12++
        ) {
        ...
        for (
          var _i14 = 0, _this$templatedFiles4 = this.templatedFiles;
          _i14 < _this$templatedFiles4.length;
          _i14++
        ) {
    ...
    },
    {
      ...
      value: function updateFileTypeConfig() {
        ...
        for (
          var _i18 = 0, _this$modules8 = this.modules;
          _i18 < _this$modules8.length;
          _i18++
        ) {
          var _module5 = _this$modules8[_i18];
          fileType =
            _module5.getFileType({
              zip: this.zip,
              contentTypes: contentTypes,
              contentTypeXml: contentTypeXml,
              overrides: overrides,
        ...
        for (
          var _i20 = 0, _this$modules10 = this.modules;
          _i20 < _this$modules10.length;
          _i20++
        ) {
          var _module6 = _this$modules10[_i20];
          for (
            var _i22 = 0, _ref4 = _module6.xmlContentTypes || [];
            _i22 < _ref4.length;
            _i22++
          ) {
    ...
    },
    {
      ...
      value: function render(data) {
        ...
        for (var _i24 = 0; _i24 < output.length; _i24++) {
          ...
          for (
            var _i26 = 0, _this$modules12 = this.modules;
            _i26 < _this$modules12.length;
            _i26++
          ) {
