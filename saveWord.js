...
function injectPlaceholders(zip) {
    ...
    const replacements = {
        ...
        43: '{{skullShape}}',
        44: 'Tikinleri: {{cranialSutures}}',
        45: '{{skullSymmetry}}',
        46: 'Kelleçanagyň çukurjuklary: {{cranialFossa}}',
        48: 'Operasiýadan soňky üýtgemeler: {{postoperativeChanges}}',
        49: '{{differentiation}}',
        50: '{{parenchymaChanges}} Geterotopiýa: {{heterotopia}} Gippokamp: {{hippocampusSymmetry}} {{hippocampusLesions}}',
        55: '{{liquorSpaces}}',
        56: '',
        57: '',
        58: '',
